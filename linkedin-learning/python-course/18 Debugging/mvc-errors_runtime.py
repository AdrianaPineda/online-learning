...
class Duck(AnimalActions):
    strings = dict(
        ...
        #faethers = "The duck has gray and white feathers." # typo here
    )
...
def in_the_forest(duck):
    print(duck.quack())
    #print(duck.feathers) # Prints as `bound method AnimalActions.feathers` So we
    # are trying to print the method instead of calling it
    print(duck.feathers()) # Fixes ^
